...
Public Class Form2
    ...
    Private Sub TambahData()
        ...
        Dim kodemk As String = txtKdmk.Text
        Dim namamk As String = txtNmk.Text
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(matakuliah_api & "?kodemk=" & txtKdmk.Text, "PUT", byteArray)
    ...
    Private Sub DeleteData()
        ...
        Try
            ...
            ' Send the PUT request and get the response
            Dim responseBytes As Byte() = client.UploadData(matakuliah_api & "?kodemk=" & txtKdmk.Text, "DELETE", byteArray)
    ...
    Private Sub GetData()
        Using client As New HttpClient()
            ...
            Dim response As HttpResponseMessage = client.GetAsync(matakuliah_api & "?kodemk=" & txtKdmk.Text).Result
                ...
                Finally
                    If (matakuliah_baru = False) Then
                        ...
                        For Each mydata As Matakuliah In data
                            txtKdmk.Text = mydata.kodemk
                            txtNmk.Text = mydata.namamk
